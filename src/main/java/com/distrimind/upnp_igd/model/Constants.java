...
public class Constants {
    ...
    public static String REGEX_NAMESPACE = "[a-zA-Z0-9\\-\\.]+";
    public static String REGEX_TYPE = "[a-zA-Z_0-9\\-]{1,64}";
    public static String REGEX_ID = "[a-zA-Z_0-9\\-:\\.]{1,64}";
    ...
    public static String REGEX_UDA_NAME = "[a-zA-Z0-9^-_\\p{L}\\p{N}]{1}[a-zA-Z0-9^-_\\.\\\\p{L}\\\\p{N}\\p{Mc}\\p{Sk}]*";
