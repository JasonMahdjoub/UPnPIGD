...
package com.distrimind.upnp.platform;
...
import com.distrimind.upnp.transport.impl.*;
...
public abstract class PlatformUpnpServiceConfiguration {
	...
	static
	{
		...
		try {
			@SuppressWarnings("unchecked") Class<? extends PlatformUpnpServiceConfiguration> c=(Class<? extends PlatformUpnpServiceConfiguration>)Class.forName("com.distrimind.upnp.android.platform.AndroidPlatformUpnpServiceConfiguration");
		...
		constructor=null;
		try {
			@SuppressWarnings("unchecked") Class<? extends PlatformUpnpServiceConfiguration> c=(Class<? extends PlatformUpnpServiceConfiguration>)Class.forName("com.distrimind.upnp.desktop.platform.DesktopPlatformUpnpServiceConfiguration");
			constructor=c.getConstructor();
		} catch (ClassNotFoundException | NoSuchMethodException ignored) {
		}
		...
		switch (platform)
		{
			case ANDROID:
				if (androidPlaformConstructor==null)
					throw new RuntimeException("The class com.distrimind.upnp.android.platform.AndroidPlatformUpnpServiceConfiguration was not found. Please import UPnPIGD-Android library.");
				constructor=androidPlaformConstructor;
				break;
			case DESKTOP:
				if (desktopPlaformConstructor==null)
					throw new RuntimeException("com.distrimind.upnp.desktop.platform.DesktopPlatformUpnpServiceConfiguration was not found. Please import UPnPIGD-Desktop library.");
