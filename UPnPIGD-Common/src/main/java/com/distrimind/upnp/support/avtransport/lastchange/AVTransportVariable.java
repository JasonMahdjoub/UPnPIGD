...
package com.distrimind.upnp.support.avtransport.lastchange;
...
import com.distrimind.upnp.support.lastchange.EventedValue;
import com.distrimind.upnp.support.lastchange.EventedValueEnum;
import com.distrimind.upnp.support.lastchange.EventedValueEnumArray;
import com.distrimind.upnp.support.lastchange.EventedValueString;
import com.distrimind.upnp.support.lastchange.EventedValueURI;
import com.distrimind.upnp.support.lastchange.EventedValueUnsignedIntegerFourBytes;
...
public class AVTransportVariable {
    ...
    public static class TransportState extends EventedValueEnum<com.distrimind.upnp.support.model.TransportState> {
        public TransportState(com.distrimind.upnp.support.model.TransportState avTransportState) {
        ...
        @Override
        protected com.distrimind.upnp.support.model.TransportState enumValueOf(String s) {
            return com.distrimind.upnp.support.model.TransportState.valueOf(s);
        }
    }

    public static class TransportStatus extends EventedValueEnum<com.distrimind.upnp.support.model.TransportStatus> {
        public TransportStatus(com.distrimind.upnp.support.model.TransportStatus transportStatus) {
        ...
        @Override
        protected com.distrimind.upnp.support.model.TransportStatus enumValueOf(String s) {
            return com.distrimind.upnp.support.model.TransportStatus.valueOf(s);
        }
    }
    ...
    public static class RecordMediumWriteStatus extends EventedValueEnum<com.distrimind.upnp.support.model.RecordMediumWriteStatus> {
        public RecordMediumWriteStatus(com.distrimind.upnp.support.model.RecordMediumWriteStatus recordMediumWriteStatus) {
        ...
        @Override
        protected com.distrimind.upnp.support.model.RecordMediumWriteStatus enumValueOf(String s) {
            return com.distrimind.upnp.support.model.RecordMediumWriteStatus.valueOf(s);
        }
    }
