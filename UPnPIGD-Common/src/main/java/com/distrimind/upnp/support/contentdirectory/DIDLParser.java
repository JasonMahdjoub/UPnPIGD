...
import com.distrimind.upnp.support.model.DIDLAttribute;
import com.distrimind.upnp.support.model.DIDLContent;
import com.distrimind.upnp.support.model.DIDLObject;
import com.distrimind.upnp.support.model.DescMeta;
...
import com.distrimind.upnp.support.model.WriteStatus;
...
import static com.distrimind.upnp.model.XMLUtil.appendNewElement;
 ...
 * </p>
 * <p>
 * Override the {@link #createDescMetaHandler(com.distrimind.upnp.support.model.DescMeta, Handler)}
 * method to read vendor extension content of {@code <desc>} elements. You then should also override the
 * {@link #populateDescMetadata(IXmlWriter, com.distrimind.upnp.support.model.DescMeta)} method for writing.
 * </p>
 * <p>
 * Override the {@link #createItemHandler(com.distrimind.upnp.support.model.item.Item, Handler)}
...
public class DIDLParser extends SAXParser {
     ...
     * {@link #createDescMetaHandler(com.distrimind.upnp.support.model.DescMeta, Handler)},
     ...
     * {@link com.distrimind.upnp.support.model.DIDLContent#DESC_WRAPPER_NAMESPACE_URI}.
     */
