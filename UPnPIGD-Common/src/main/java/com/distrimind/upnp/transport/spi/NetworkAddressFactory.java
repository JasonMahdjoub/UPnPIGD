...
public interface NetworkAddressFactory {
	...
	String SYSTEM_PROPERTY_NET_IFACES = "com.distrimind.upnp.network.useInterfaces";
    String SYSTEM_PROPERTY_NET_ADDRESSES = "com.distrimind.upnp.network.useAddresses";
